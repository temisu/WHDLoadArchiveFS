...
extern int32_t archivefs_common_simpleRead(void *dest,uint32_t length,uint32_t offset,struct archivefs_state *container);
...
extern void archivefs_common_insertFileEntry(struct archivefs_state *container,struct archivefs_cached_file_entry *entry);

...
;=============================================================================
	...
	; storage
	; LONG cont regEntry(const CPTR path, const APTR fib)
	; it returns:
	;	0 - stop processing
	...
	; APTR mem allocFile(const CPTR filename, ULONG size)
	; it returns:
	...
	; LONG error fileRead(APTR wvfs, APTR dest, const CPTR name, ULONG length, ULONG offset)
	APTR	wvfs_fileRead
